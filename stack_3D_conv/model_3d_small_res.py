...
class Gesture3DNetSmallRes(nn.Module):
    def __init__(self):
        super(Gesture3DNetSmallRes, self).__init__()
...
if __name__ == "__main__":
    ...
    model = Gesture3DNetSmallRes().to(device)
    summary(model, (20, 3, 120, 160), device=device)
